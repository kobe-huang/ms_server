...
--                                      --
--                                      --
--170601  10:35:20    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
local index = self.qq_app_data.app_info.current_user_index
...
function qq_app_class:func_qq_group_add_friends()
    ---qq群加好友次数
    local group_add_num = self.qq_app_data.user_list[index].user_data.qq_group_add_friends_num
end
...
function qq_app_class:func_qq_change_login()
    --qq群加好友换号次数
    local change_num = self.qq_app_data.user_list[index].user_data.qq_change_login_num
...
function qq_app_class:func_qq_change_login_finish(num_login)
    ...
    if num_login == true then
        self.qq_app_data.user_list[index].user_data.qq_change_login_num = change_num + 1
    else
        self.qq_app_data.user_list[index].user_data.qq_change_login_num = 0  --初始化
    end
end
-------------------------------------------test 部分-------------------------
...
local function action_xiaoxi() --执行这个页面的操作--
    ...
    gongneng == "pull_people_into_group" or gongneng == "hair_message_friends"  then
        cicky( 321,1067,50);  --点击联系人
        mSleep(1000)
        page_array["page_lianxiren"]:enter()
    elseif gongneng == "change_login" then
        cicky(  59,89,1000);  --长按切换账号
        mSleep(1000);
        local my_qq_app = qq_app_class:new();
        local num_login = my_qq_app:do_func("qq_change_login")  --读取登录次数
        cicky( 183,258+92*(num_login -1),50)
        mSleep(2000)
        --没号了
        ...
        if x ~= -1 and y ~= -1 then  -- 如果找到了
            ...
            mSleep(1500)
            my_qq_app:finish_func("qq_change_login",false)  --初始化登录次数
        end
    ...
    elseif gongneng == "del_message" then  --删除这条消息
        ...
        mSleep(1500)
        return true
    elseif gongneng == "reply_message_friends"  then  --回复消息给好友
        cicky( 313,216,50);   --点击第一条消息
        mSleep(1500)
        if page_array["page_friends_chat"]:quick_check_page() == true then
...
local function action_lianxiren() --执行这个页面的操作--
    ...
    elseif gongneng == "hair_message_frineds" then
        ...
        if page_array["page_friends_chat"]:quick_check_page() == true then
            page_array["page_friends_chat"]:action()
        elseif page_array["page_application_jiahaoyou"]:quick_check_page() == true then
    ...
    elseif gongneng == "fashuoshuo" or gongneng == "comment_friends_shuoshuo" then
        ...
        mSleep(1000)
        page_array["page_dongtai"]:enter()
    elseif gongneng == "group_message_add_friends" or gongneng == "change_login" or gongneng == "reply_message_friends" then
...
local function action_dongtai() --执行这个页面的操作--
    ...
    elseif gongneng == "add_friends" or gongneng == "add_group"or gongneng == "group_add_friends" or gongneng == "pull_people_into_group" or gongneng == "hair_message_frineds" then
        cicky( 321,1067,50);  --点击联系人
        mSleep(1000)
        page_array["page_lianxiren"]:enter()
    elseif gongneng == "group_message_add_friends" or gongneng == "change_login" or gongneng == "reply_message_friends" then
...
function tongxunlu_page:enter()        --进入页面后的动作--
    if 1 or 3 or 4 == self.check_page(self) then
        return self.action(self)
...
local function action_friends_chat() --执行这个页面的操作--
    if gongneng == "hair_message_frineds" or gongneng == "reply_message_frineds" then
        ...
        cicky(60,80,50);  --点击返回
        mSleep(1500)
        if gongneng == "reply_message_frineds" then
            move( 504,215, 100,215,8);   --滑动删除
            mSleep(1000)
            cicky(593,216,50);   --点击删除
            mSleep(1500)
        ...
        if page_array["page_lianxiren"]:quick_check_page() == true then
            page_array["page_lianxiren"]:action()
        end
