...
--                                      --
--                                      --
--170601  10:47:00    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
function qq_app_class:func_qq_change_login()
    local index = self.app_info.current_user_index
    --qq群加好友换号次数
    local change_num = self.user_list[index].user_data.qq_change_login_num
...
function qq_app_class:func_qq_change_login_finish(num_login)
    ...
    if num_login == true then
        self.user_list[index].user_data.qq_change_login_num = change_num + 1
    else
        self.user_list[index].user_data.qq_change_login_num = 0  --初始化
    end
end
-------------------------------------------test 部分-------------------------
