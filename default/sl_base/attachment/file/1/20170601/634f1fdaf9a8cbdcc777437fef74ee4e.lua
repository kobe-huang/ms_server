...
--                                      --
--                                      --
--170601  12:04:24    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
function qq_app_class:func_qq_change_login_finish(num_login)
    ...
    if num_login == true then
        ...
        self.app_info.user_list[index].user_data.qq_change_login_num = 0  --初始化
    end
end
-------------------------------------------test 部分-------------------------
...
local function action_xiaoxi() --执行这个页面的操作--
    ...
    elseif gongneng == "change_login" then
        ...
        local num_login = my_qq_app:do_func("qq_change_login")  --读取登录次数  从0开始
        cicky( 183,258+92*num_login,50)   --点击num_login +1 的账号
        mSleep(2000)
        --没号了
...
local function action_tencent_news() --执行这个页面的操作--
    if gongneng == "group_message_add_friends" or gongneng == "reply_message_friends" then
...
local function action_friends_chat() --执行这个页面的操作--
    if gongneng == "hair_message_friends" or gongneng == "reply_message_friends" then
        --需要点击输入框
        x, y = findMultiColorInRegionFuzzy({ 0x7F8393, 1, 28, 0x7F8393, 11, 16, 0xEDEEF1, 100, -3, 0x7F8393, 125, 20, 0x7F8393, 97, 14, 0xEDEEF1, 226, 26, 0xEDEEF1, 233, -7, 0xEDEEF1, 325, 12, 0x7F8393, 313, 3, 0xEDEEF1, 454, 24, 0xEDEEF1, 541, 16, 0xEDEEF1, 541, 16, 0xEDEEF1 }, 90, 54, 1066, 595, 1101);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
        ...
        cicky(60,80,50);  --点击返回
        mSleep(1500)
        if gongneng == "reply_message_friends" then
            move( 504,222, 100,222,8);   --滑动删除
            mSleep(1000)
            cicky(593,216,50);   --点击删除
            mSleep(1500)
