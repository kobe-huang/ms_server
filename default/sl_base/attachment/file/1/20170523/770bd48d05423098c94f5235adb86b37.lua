...
--                                             --
--                                             --
--170523  10:51:44    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
local function action_liaotianxinxi()     --操作
    ...
    elseif gongneng == "保存" then 
        ...
        if x1 ~= -1 or x2 ~= -1 then  -- 如果找到了
            --点击按钮1
            x3, y3 = findMultiColorInRegionFuzzy({ 0xFFFFFF, 35, -2, 0xFAFAFA, 54, 2, 0xFEFEFE, 69, 11, 0xFFFFFF, 66, 29, 0xFFFFFF, 31, 34, 0xFFFFFF, 4, 25, 0xFFFFFF, 1, 9, 0xFFFFFF, 51, 0, 0xFEFEFE, 72, 19, 0xFFFFFF, 27, 34, 0xFFFFFF, 0, 8, 0xFFFFFF, 30, 1, 0xFFFFFF, 44, 15, 0xF8F8F8, 10, 8, 0xFFFFFF, 51, 16, 0xFCFCFC, 52, 7, 0xFEFEFE, 63, 36, 0xFFFFFF, 45, 14, 0xF9F9F9, 47, 2, 0xFDFDFD }, 90, 526, 246, 598, 284);
            --点击按钮2
            ...
            elseif x4 ~= -1 and y4 ~= -1 then  -- 如果找到了
                cicky(x4,y4,50)
                mSleep(1500)
