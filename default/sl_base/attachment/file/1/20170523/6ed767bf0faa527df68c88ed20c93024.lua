...
--                                             --
--                                             --
--170523  10:46:35    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
local function action_liaotianxinxi()     --操作
    ...
    elseif gongneng == "保存" then 
        ...
        if x1 ~= -1 or x2 ~= -1 then  -- 如果找到了
            --点击按钮1
           x1, y1 = findMultiColorInRegionFuzzy({ 0xFFFFFF, 3, 21, 0xFFFFFF, 36, 34, 0xCBCBCB, 61, 23, 0xFFFFFF, 55, -2, 0xFFFFFF, 20, -4, 0xFFFFFF, 17, 18, 0xFFFFFF, 58, 24, 0xFEFEFE, 67, 5, 0xFFFFFF, 34, 3, 0xFEFEFE, 33, 4, 0xFFFFFF }, 90, 527, 245, 594, 283);
            --点击按钮2
