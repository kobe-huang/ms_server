...
--                                             --
--                                             --
--170512  16:58:36    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
local function action_sousuojiahaoyou()     --操作
    if gongneng == 2.11 then
        ...
        if gong_neng == "新号" then   --加新号为好友
            ...
            if nv_read_nv_item(xinhao_info[1]) == nil then
                nv_write_nv_item(xinhao_info[1],0)
            else
                nv_write_nv_item(xinhao_info[add_num],xinhao_info)
            end
