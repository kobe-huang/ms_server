...
--                                             --
--                                             --
--170512  17:08:02    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
local function action_sousuojiahaoyou()     --操作
    if gongneng == 2.11 then
        ...
        if gong_neng == "新号" then   --加新号为好友
            ...
            if add_num > 5 then
                warning_info("已经添加5个新号，不再添加新号")
                return false
            end
            if nv_read_nv_item(xinhao_info.data[1]) == nil then
                nv_write_nv_item(xinhao_info.data[1],0)
            else
                nv_write_nv_item(xinhao_info.data[add_num],xinhao_info)
            end
