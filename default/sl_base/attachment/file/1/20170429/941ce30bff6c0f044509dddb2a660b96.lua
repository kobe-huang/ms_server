...
--                                             --
--                                             --
--170429  17:24:50    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
local function action_weixinzhu()     --执行这个页面的操作--
    ...
    elseif gongneng == 1.2 then  --删除信息
        ...
        mSleep(3000);
        ---群聊删除
        x,y = findColorInRegion(0xFF3B30, 4,763 ,637,853 )
        if x ~= -1 and y ~= -1 then  -- 如果找到了
            cicky(x,y,50);
            mSleep(2000)
        end
...
local function action_tongxunlu()     --操作
    ...
    elseif gongneng == 2.7 then  --统计好友数量
        ...
        mSleep(1000)
        --10+人数
        x, y = findMultiColorInRegionFuzzy({ 0xFFFFFF, 31, 1, 0xFFFFFF, 108, 5, 0x808080, 111, 10, 0xFFFFFF, 117, 29, 0xFFFFFF, 81, 28, 0xFFFFFF, 38, 28, 0xFDFDFD, 15, 26, 0xFFFFFF, 3, 19, 0xFFFFFF, 2, 18, 0xFFFFFF, 39, 18, 0x808080, 68, 18, 0xB6B6B6, 102, 18, 0xFFFFFF, 103, 18, 0xFFFFFF }, 90, 282, 795, 399, 824);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
            code = localOcrText("/var/touchelf/tessdata","eng",  -- 识别数字
                 231,800,269,824 , "0123456789"  )                                 
            if code == "" then
    ...
    elseif gongneng == 4.1 or gongneng == 4.2 or gongneng == 4.3 then
        ...
        mSleep(1500);
        page_array["page_wo"]:enter();
    elseif gongneng == 1.1 or gongneng == 1.12 or gongneng == 1.4 then   --智能回复
...
local function action_wo()     --执行这个页面的操作--
    ...
    elseif gongneng == 1.1 or gongneng == 1.12 or gongneng == 1.4 then
        cicky(  81,911,50);  --点击微信
        mSleep(1500);
        page_array["page_weixinzhu"]:enter()
    elseif gongneng == 5.1 or gongneng == 5.2 or gongneng == 5.3 or gongneng == 3.31 then
...
local num = math.random(200,250)  --添加联系人数量
...
local function action_soudaole()     --操作
    if  gongneng == 2.11 then 
        xiahua();
        ---添加到通讯录1.bmp
        ddzc(0x1AAD19, 122, 6, 0xBEE8BE, 308, 24, 0xFEFFFE, 447, 33, 0x1AAD19, 90, 117, 835, 564, 868);
        if x>0 and y>0 then
            cicky(x,y,50);   ---点击添加到通讯录
            mSleep(5000);
            for i=1,5 do
                ---需要验证
         ...
         ---添加到通讯录2.bmp
        ddzc(0x1AAD19, 76, -2, 0x1AAD19, 235, -3, 0x54C254, 251, 7, 0x1DAE1C, 90, 168, 759, 419, 769);
        if x>0 and y>0 then
            cicky(x,y,50);   ---点击添加到通讯录
            mSleep(5000);
            for i=1,5 do
...
local function action_jiagongzhonghao()     --操作
    if gongneng == 2.12 then
        mSleep(1000);
        inputText(gongzhonghao[math.random(#gongzhonghao)]);     --输入名字
        mSleep(1500);
...
local function action_xiangxizl()     --执行这个页面的操作--
    if gongneng == 2.4 then  -- 转发朋友圈
        ...
        cicky(  73,83,50);   --点击返回
        mSleep(2500);
        if page_array["page_liaotian"]:quick_check_page() == true and gongneng == 1.1 or gongneng == 2.6 or gongneng == 1.12  then
            cicky(  73,83,50);   --点击返回
            mSleep(2500);
            cicky(596,75,50);   --点击取消
            mSleep(2000);  
