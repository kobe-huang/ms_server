...
--                                      --
--                                      --
--170603  11:54:41    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
local function check_page_xiaoxi()
    ...
    if x ~= -1 and y ~= -1 then  -- 如果找到了
        ...
        x, y = findMultiColorInRegionFuzzy({ 0xFFFFFF, 29, 5, 0x12B7F5, 38, 15, 0x56CBF7, 3, 19, 0xFFFFFF, 5, 1, 0xFFFFFF, 30, 6, 0x3DC4F6, 5, 17, 0x12B7F5, -24, 4, 0xFFFFFF, -29, 21, 0xFFFFFF, 15, 26, 0xFFFFFF, 90, 0, 0x6ED1F6, 149, 0, 0x6ED1F6, 170, 10, 0x6ED1F6, 136, 26, 0x6ED1F6, 121, 9, 0xFFFFFF, 155, 6, 0xFFFFFF, 138, 24, 0x6ED1F6, 99, 19, 0x6ED1F6, 109, 34, 0x6ED1F6, 159, 31, 0x6ED1F6, 175, 11, 0x6ED1F6, 120, -2, 0x6ED1F6, 59, 2, 0xFFFFFF, 107, 6, 0x6ED1F6, 124, 21, 0x6ED1F6, 67, 23, 0xFFFFFF, 115, 11, 0x6ED1F6 }, 90, 213, 65, 417, 101);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
...
local function action_lianxiren() --执行这个页面的操作--
    ...
    elseif gongneng == "fashuoshuo" or gongneng == "comment_friends_shuoshuo" then
        ...
        mSleep(1000)
        page_array["page_dongtai"]:enter()
    elseif gongneng == "group_message_add_friends" or gongneng == "change_login" or gongneng == "reply_message_friends" or gongneng== "reply_friends_message" then
...
local function action_dongtai() --执行这个页面的操作--
    ...
    elseif gongneng == "add_friends" or gongneng == "add_group"or gongneng == "group_add_friends" or gongneng == "pull_people_into_group" or gongneng == "hair_message_friends" then
        cicky( 321,1067,50);  --点击联系人
        mSleep(1000)
        page_array["page_lianxiren"]:enter()
    elseif gongneng == "group_message_add_friends" or gongneng == "change_login" or gongneng == "reply_message_friends" or gongneng== "reply_friends_message" then
...
local function check_page_tongxunlu()
    ...
    if x ~= -1 and y ~= -1 then  -- 如果找到了
       ...
       x, y = findMultiColorInRegionFuzzy({ 0x12B7F5, 1, 0, 0x12B7F5, 16, 0, 0x12B7F5, 23, 1, 0x12B7F5, 34, 3, 0x12B7F5, 44, 6, 0x55CBF8, 62, 6, 0x6DD3F9, 101, 6, 0x12B7F5, 126, 6, 0x56CCF8, 135, 6, 0x12B7F5, 171, 6, 0x12B7F5, 192, 6, 0x2EBFF6, 203, 9, 0x12B7F5, 203, 17, 0x2CBFF6, 174, 17, 0xFFFFFF, 123, 20, 0x12B7F5, 74, 20, 0xFFFFFF, 44, 19, 0xFFFFFF, 19, 16, 0x88DBFA, 17, 14, 0xFFFFFF, 21, 24, 0x52CAF8, 68, 33, 0x12B7F5, 129, 33, 0x12B7F5, 165, 33, 0x12B7F5, 190, 25, 0xFFFFFF, 195, 16, 0x12B7F5, 184, 15, 0xFFFFFF, 76, 15, 0x12B7F5, 29, 12, 0xFFFFFF, 12, 10, 0xECF9FE, 108, -5, 0x12B7F5, 171, 0, 0x12B7F5, 190, 9, 0x9EE2FB, 196, 13, 0x12B7F5 }, 90, 217, 62, 420, 100);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
