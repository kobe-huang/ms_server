...
--                                      --
--                                      --
--170603  15:23:38    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
local function action_xiaoxi() --执行这个页面的操作--
    if gongneng == "add_group" or gongneng == "add_friends" or gongneng == "pull_people_into_group" or gongneng == "hair_message_friends" or gongneng == "agree_friends_add_request" then
...
local function action_dongtai() --执行这个页面的操作--
    ...
    elseif gongneng == "add_friends" or gongneng == "add_group"or gongneng == "group_add_friends" or gongneng == "pull_people_into_group" or gongneng == "hair_message_friends" or gongneng == "agree_friends_add_request" then
        cicky( 321,1067,50);  --点击联系人
        mSleep(1000)
        page_array["page_lianxiren"]:enter()
    elseif gongneng == "group_message_add_friends" or gongneng == "change_login" or gongneng == "reply_friends_message"  then
...
local function action_new_friends_add() --执行这个页面的操作--
    if gongneng == "agree_friends_add_request" then  --添加群
        --没有消息1
        x1, y1 = findMultiColorInRegionFuzzy({ 0xF7F7F9, 45, 4, 0xF7F7F9, 187, 3, 0xF7F7F9, 157, 3, 0xF7F7F9, 74, 3, 0xBBBBBB, -9, 3, 0xB3B3B3, -21, 3, 0xAAAAAA, 19, 17, 0xF6F6F8, 69, 15, 0xAFAFAF, 129, 14, 0xF7F7F9, 170, 12, 0xF5F5F7, 190, 12, 0xF7F7F9 }, 90, 220, 778, 431, 795);
         --没有消息2
        x2, y2 = findMultiColorInRegionFuzzy({ 0xC5C5C6, 55, 0, 0xF7F7F9, 113, 0, 0xF7F7F9, 171, 0, 0xEEEEF0, 203, 6, 0xD6D6D7, 214, 14, 0xF7F7F9, 156, 17, 0xF7F7F9, 65, 17, 0xF6F6F8, 15, 17, 0xC7C7C8, 10, 2, 0xF7F7F9, 35, 5, 0xF7F7F9, 148, 10, 0xF7F7F9, 195, 10, 0xADADAD, 164, -101, 0xF7F7F9, 137, -51, 0xF7F7F9, 137, -76, 0xF7F7F9, 57, -80, 0xF7F7F9 }, 90, 213, 676, 427, 794);
        ...
        if page_array["page_new_friends_add"]:check_page() == true then
            x, y = findMultiColorInRegionFuzzy({ 0xF7F7F8, 48, 0, 0xD1D1D2, 71, 0, 0x8E8E8F, 87, 0, 0xBFBFC0, 101, 1, 0x999999, -1, 12, 0xEEEEEE, 23, 11, 0xF7F7F8, 66, 10, 0xF5F5F6, 100, 8, 0xF7F7F8, 110, 4, 0xF7F7F8, 46, 1, 0x9A9A9A, 46, 1, 0x9A9A9A }, 90, 27, 149, 138, 161);
            if x ~= -1 and y ~= -1 then  -- 如果找到了
