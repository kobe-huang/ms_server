...
--                                      --
--                                      --
--170603  19:16:46    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
local function action_new_friends_add() --执行这个页面的操作--
    if gongneng == "agree_friends_add_request" then  --添加群
        --没有消息1
        x, y = findMultiColorInRegionFuzzy({ 0xF7F7F9, 48, 0, 0xA7A7A7, 106, 0, 0xA6A6A6, 148, -1, 0xD4D4D6, 147, 10, 0xF7F7F9, 54, 13, 0xADADAD, -22, 13, 0xF7F7F9, -51, 13, 0xC6C6C7, 52, 10, 0xF7F7F9, 84, 10, 0xB5B5B5, 116, 10, 0xF7F7F9, 155, 7, 0xF7F7F9 }, 90, 224, 785, 430, 799);
         --没有消息2
