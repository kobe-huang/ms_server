...
--                                      --
--                                      --
--170526  10:12:03    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
local function check_page_xiaoxi()
    x, y = findMultiColorInRegionFuzzy({ 0xFFFFFF, 52, 1, 0xFFFFFF, 73, 6, 0xFFFFFF, 68, 34, 0xFFFFFF, 38, 33, 0xFFFFFF, 25, 18, 0x12B7F5, 63, 13, 0xFFFFFF, 44, 24, 0x12B7F5, -4, 17, 0xFFFFFF, 37, 7, 0xFFFFFF, -9, 20, 0xFFFFFF, 117, 35, 0x12B7F5, 115, 18, 0x12B7F5, 155, 8, 0x12B7F5, 186, 16, 0x12B7F5, 144, 30, 0x12B7F5, 138, 16, 0x12B7F5, 181, 9, 0x12B7F5, 160, 29, 0xECF9FE, 131, 22, 0x12B7F5, 169, 23, 0xF4FCFF, 203, 33, 0x12B7F5, 217, 17, 0x12B7F5, 189, 6, 0x12B7F5, 347, -1, 0x12B7F5, 382, 5, 0x12B7F5, 367, 32, 0xFFFFFF, 368, -5, 0x12B7F5, 380, 20, 0xFFFFFF, 351, 26, 0x12B7F5, 368, 2, 0x12B7F5, 327, 23, 0x12B7F5, 319, 4, 0x12B7F5, 349, 17, 0x12B7F5, 351, 28, 0x12B7F5 }, 90, 218, 56, 609, 96);
    if x ~= -1 and y ~= -1 then  -- 如果找到了
        log_info("----qq消息界面1-7.0---");
        return true
    else
        x, y = findMultiColorInRegionFuzzy({ 0xFFFFFF, 78, -3, 0xFFFFFF, 84, 13, 0xFFFFFF, 60, 26, 0xF8FDFE, 21, 18, 0xFFFFFF, 43, 3, 0xFFFFFF, 59, 10, 0x12B7F5, 53, 19, 0x50C9F7, -2, 21, 0xFFFFFF, -18, 5, 0x6ED1F6, -9, 35, 0xFFFFFF, 55, 48, 0xFFFFFF, 136, -2, 0x6ED1F6, 210, -1, 0x6ED1F6, 216, 9, 0x6ED1F6, 212, 32, 0x6ED1F6, 172, 39, 0x6ED1F6, 132, 28, 0x6ED1F6, 142, 14, 0xBCEAFB, 198, 19, 0x6ED1F6, 155, 20, 0x8ADAF8, 175, 7, 0x6ED1F6, 366, 17, 0x6ED1F6, 375, 36, 0x6ED1F6, 395, 6, 0x6ED1F6, 392, -1, 0x6ED1F6, 379, 17, 0x7FD6F7, 384, 36, 0xFFFFFF, 391, 7, 0x6ED1F6, 386, 30, 0x6ED1F6, 370, 16, 0x6ED1F6 }, 90, 194, 59, 607, 110);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
...
local function action_input_search() --执行这个页面的操作--
    ...
    elseif gongneng == "add_group" then  --添加群
        --输入群信息搜索
        if text_appoint_group_info ~= nil and text_appoint_group_info[1] ~= nil then
