...
--                                      --
--                                      --
--170605  20:47:37    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
local function action_new_friends_add() --执行这个页面的操作--
    if gongneng == "agree_friends_add_request" then  --添加群
        ...
        if page_array["page_new_friends_add"]:check_page() == true then
            --好友通知
            x, y = findMultiColorInRegionFuzzy({ 0x9E9E9F, 13, -1, 0xBEBEBE, 29, -1, 0xB4B4B5, 73, 1, 0xF6F6F7, 88, 1, 0xF7F7F8, 107, 1, 0xF7F7F8, 108, 3, 0xF7F7F8, 73, 16, 0xB3B3B4, 43, 10, 0xF7F7F8, 18, 5, 0xA8A8A8, 6, 5, 0xABABAB, 15, 2, 0xF7F7F8, 82, 2, 0xF7F7F8, 93, 3, 0x898989, 75, 13, 0xF7F7F8, 4, 18, 0xF7F7F8, 4, 18, 0xF7F7F8, 68, 17, 0x8E8E8F, 81, 16, 0x797979 }, 90, 32, 151, 140, 170);
            if x ~= -1 and y ~= -1 then  -- 如果找到了
