...
--                                              --
--                                              --
--170516  20:08:09    luoshui package 
--                                              --
--                                              --
--                                              --
--------------------------------------------------
...
local function action_phone_book_opt() --执行这个页面的操作--
    ...
    if gongneng == 5.3 then
        if nv_read_nv_item("Number of contact people") == nil  then
            ...
            warning_info("还不到时间删除联系人");
            mSleep(1000)
            return false
        else
            if nv_read_nv_item("Number of contact people") > 210 then
                log_info("删完联系人");
                mSleep(1000)
            else
                warning_info("还不到时间删除联系人");
...
local function action_suoyoulianxiren_delete()     --执行这个页面的操作-
     if nv_read_nv_item("Number of contact people") ~= nil then
        if nv_read_nv_item("Number of contact people") > 31 then
...
-- local num = 200  --添加联系人个数
local function action_suoyoulianxiren_add()     --执行这个页面的操作--
    if nv_read_nv_item("Number of contact people") == nil then
        nv_write_nv_item("Number of contact people",1)
    else
        if nv_read_nv_item("Number of contact people") > 30 then
            warning_info("联系人已经添加")
            mSleep(1000)
            return false
        end
        contact = nv_read_nv_item("Number of contact people") + 1 
...
----------------------begin:  func\photo_book\WeChar_main.lua---------------------------------
...
------------------end:  func\photo_book\WeChar_main.lua-------------------------------------
