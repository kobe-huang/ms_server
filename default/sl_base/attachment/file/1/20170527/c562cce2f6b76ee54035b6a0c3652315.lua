...
--                                      --
--                                      --
--170527  10:53:39    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
local function check_page_xiaoxi()
    ...
    if x ~= -1 and y ~= -1 then  -- 如果找到了
        ...
        x, y = findMultiColorInRegionFuzzy({ 0xFFFFFF, 9, 13, 0xFFFFFF, -27, 31, 0xCDF0FC, -50, 25, 0x12B7F5, -35, 12, 0xFFFFFF, -23, 13, 0x13B7F5, -40, 21, 0xFFFFFF, -19, 34, 0xFFFFFF, 36, 25, 0x12B7F5, 95, 5, 0x12B7F5, 117, 12, 0x12B7F5, 87, 28, 0xA9E5FB, 80, 16, 0x12B7F5, 99, 19, 0xB2E8FC, 93, 24, 0xB5E8FC, 45, 32, 0x12B7F5, 139, 37, 0x12B7F5, 141, 19, 0xFFFFFF, 135, 12, 0x12B7F5, 295, 9, 0xDFF5FE, 289, 34, 0x12B7F5, 312, 17, 0xFFFFFF, 307, -2, 0x12B7F5, 288, 11, 0x12B7F5, 298, 20, 0xFFFFFF, 298, 22, 0xFFFFFF, 289, 2, 0x12B7F5, 298, 7, 0xFFFFFF, 303, 14, 0x12B7F5 }, 90, 247, 62, 609, 101);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
...
function tongxunlu_page:enter()        --进入页面后的动作--
    if 1 or 3  == self.check_page(self) then
        return self.action(self)
...
local function check_page_shy_add_verification()
    ...
    if x ~= -1 and y ~= -1 then  -- 如果找到了
       ...
       x, y = findMultiColorInRegionFuzzy({ 0xFFFFFF, 2, 8, 0x34C0F5, 2, 10, 0x71D3F8, 11, 11, 0xE0F5FD, 32, 11, 0x34C0F5, 39, 11, 0xEAF8FE, 53, 13, 0x34C0F5, 93, 14, 0x34C0F5, 113, 14, 0x34C0F5, 115, 14, 0xE0F5FD, 119, -6, 0xFFFFFF, 119, -9, 0x34C0F5, 117, -10, 0x34C0F5, 124, 2, 0xB7E9FB, 121, 8, 0xE0F5FD, 101, 2, 0x34C0F5, 23, 1, 0x34C0F5, 17, 3, 0x34C0F5, 74, 3, 0x34C0F5, 104, 3, 0xFFFFFF, 105, 3, 0xFFFFFF, 17, -5, 0x34C0F5, 74, -5, 0x86D9F9, 100, -5, 0x34C0F5, 117, -5, 0x50C9F6, 116, 13, 0xFFFFFF, 139, 5, 0x34C0F5, 132, 11, 0x34C0F5, -13, 10, 0x34C0F5, -11, 14, 0x34C0F5 }, 90, 244, 69, 396, 93);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
...
local function check_page_shy_send_verification()
    ...
    if x ~= -1 and y ~= -1 then  -- 如果找到了
       ...
       x, y = findMultiColorInRegionFuzzy({ 0x34C0F5, 1, 0, 0x34C0F5, 16, 0, 0x34C0F5, 16, 0, 0x34C0F5, 33, 4, 0x34C0F5, 68, 4, 0x34C0F5, 99, 4, 0x34C0F5, 112, 4, 0xFFFFFF, 128, 4, 0x34C0F5, 128, 6, 0xFFFFFF, 124, 20, 0x34C0F5, 124, 21, 0x34C0F5, 3, 25, 0x34C0F5, 60, 25, 0x9FE1FA, 93, 24, 0x34C0F5, 127, 23, 0x34C0F5, 139, 23, 0x34C0F5, 57, 17, 0x80D7F9, 66, 17, 0x34C0F5, 107, 17, 0xFFFFFF, 119, 17, 0x34C0F5, 11, 12, 0xFFFFFF, 92, 15, 0xFFFFFF, 111, 17, 0xF9FDFF, 19, 9, 0xFFFFFF, 91, 11, 0x34C0F5, 121, 11, 0x34C0F5, 0, 5, 0x36C0F5, 50, 3, 0x34C0F5, 110, 6, 0xFFFFFF, 126, 6, 0xFFFFFF, 121, 20, 0xFFFFFF, 143, 15, 0x34C0F5, 148, 19, 0x34C0F5, -18, 9, 0x34C0F5, -18, 9, 0x34C0F5 }, 90, 239, 68, 405, 93);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
...
local function check_page_space_dynamic()
    x, y = findMultiColorInRegionFuzzy({ 0x12B7F5, 21, 2, 0x12B7F5, 63, 5, 0x1DBAF5, 84, 5, 0x12B7F5, 112, 5, 0x39C3F7, 123, 5, 0x32C1F6, 129, 6, 0xB1E7FC, 0, 13, 0x15B8F5, 16, 13, 0x12B7F5, 33, 13, 0x12B7F5, 44, 13, 0xFDFEFF, 94, 11, 0x61CFF8, 94, 11, 0x61CFF8, 112, 12, 0x12B7F5, 138, 12, 0x12B7F5, 0, 27, 0x12B7F5, 20, 27, 0xFFFFFF, 35, 27, 0xFFFFFF, 40, 27, 0x12B7F5, 78, 24, 0x6ED3F9, 119, 22, 0x61CFF8, 148, 15, 0x12B7F5, 149, 5, 0x12B7F5, 111, 10, 0x12B7F5, 71, 23, 0x23BCF6, 52, 20, 0x12B7F5, 34, 16, 0x12B7F5, 6, 13, 0x12B7F5, -2, 5, 0x12B7F5, 64, 4, 0x12B7F5, 103, 4, 0x12B7F5, 126, 9, 0x41C5F7, 133, 16, 0xEAF9FE }, 90, 251, 66, 402, 93);
    if x ~= -1 and y ~= -1 then  -- 如果找到了
