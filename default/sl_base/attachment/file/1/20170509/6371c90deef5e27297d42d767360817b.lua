...
--                                             --
--                                             --
--170509  16:15:10    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
function phone_book_app_class:func_pb_add_contact( ... )
    ...
    if self.app_info.user_list[tmp_index].user_data.phone_add_contact_num ~= 0 then
        if self.app_info.user_list[tmp_index].user_data.phone_add_contact_num  < 100 then
            return 1    --添加联系人次数
        else
            return  0    
        end
