...
--                                             --
--                                             --
--170509  11:58:58    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
function phone_book_app_class:func_pb_add_contact( ... )
    ...
    if self.app_info.user_list[tmp_index].phone_add_contact_num ~= 0 then
        if self.app_info.user_list[tmp_index].phone_add_contact_num  < 100 then
            return 200
        else
            return false
        end
...
function phone_book_app_class:func_pb_add_contact_finish(add_num)
    local tmp_index = self.app_info.current_user_index;
    local num_index1 = self.app_info.user_list[tmp_index].phone_add_contact_num
    local num_index2 = self.app_info.user_list[tmp_index].phone_add_contact_num_total
