...
--                                             --
--                                             --
--170509  16:48:50    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
function phone_book_app_class:func_pb_add_contact( ... )
    ...
    if num_phone_add  < 2 then
        local add_num = math.random(2,3) - num_phone_add
...
function phone_book_app_class:func_pb_del_contact_finish( ... )
    ...
    self.app_info.user_list[tmp_index].user_data.phone_add_contact_total_num = 0   --初始化
end
