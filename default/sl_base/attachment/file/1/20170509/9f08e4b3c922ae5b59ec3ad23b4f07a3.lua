...
--                                             --
--                                             --
--170509  17:11:35    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
function phone_book_app_class:func_pb_del_contact_finish( ... )
    self.app_info.user_list[tmp_index].user_data.phone_add_contact_num = 0  --初始化
end
...
local function action_suoyoulianxiren_delete()     --执行这个页面的操作--
    ...
    if num_book_del == true then
        warning_info("删除完全部联系人")
    else
        warning_info("联系人没到个数，不删除")
        return false
    end
    mSleep(1000)
...
function suoyoulianxiren_page:action()     --执行这个页面的操作--
    if gongneng == 5.3 then  --删除
        if true == is_exsist_contact() then
            ...
            mSleep(1000)
            my_pb_app:finish_func("pb_del_contact")   --初始化联系人个数为0
