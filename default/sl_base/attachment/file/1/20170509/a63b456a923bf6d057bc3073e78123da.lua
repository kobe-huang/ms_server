...
--                                             --
--                                             --
--170509  18:56:43    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
function phone_book_app_class:func_pb_add_contact( ... )
    ...
    if num_phone_add  < 2 then
        local add_num = math.random(3,4) - num_phone_add
        return add_num   --添加联系人次数
    else
        return  2       --一开始添加200-250个 后面每天加15*2个   
    end
end
...
local num_phone_add2 = num_phone_add
...
local function action_xindepengyou()     --操作
    if  gongneng == 2.2  then 
        if nv_read_nv_item("Accept friends")  ~= nil and strategy[1] == "3" then  --养号
            if nv_read_nv_item("Accept friends") >150 then
...
local function action_sousuo()     --执行这个页面的操作--
    if gongneng == 2.4 or gongneng == 1.5  then  -- 转发朋友圈/ 发消息
        if gongneng == 2.4 then
        ...
        if x>0 and y>0 then 
            if gongneng == 2.4 then
                warning_info("转发说说时没有这个好友");
            else
                warning_info("发消息给新号时没有这个好友")
            end
            mSleep(2000);
...
function action_wenzhang( ... )  --加载文章
    for i=1,10 do
        ---文章加载中
        mSleep(500)
        x, y = findMultiColorInRegionFuzzy({ 0x0B0B0C, 27, -1, 0x0B0B0C, 61, -1, 0x0B0B0C, 79, -1, 0x0B0B0C, 145, -1, 0x0B0B0C, 212, -1, 0x0B0B0C, 297, -2, 0x0B0B0C, 344, -2, 0x0B0B0C, 360, -2, 0x0B0B0C, 384, 4, 0x0B0B0C, 400, 24, 0x0C0C0C, 402, 38, 0x0C0C0C, 399, 50, 0x0C0C0C, 373, 58, 0x0C0C0C, 325, 58, 0x0C0C0C, 270, 57, 0x0C0C0C, 180, 53, 0x0C0C0C, 111, 51, 0x0C0C0C, 37, 44, 0x0C0C0C, 11, 20, 0x0C0B0C, 9, 16, 0x0B0B0C, 51, 22, 0x0C0C0C, 110, 23, 0x0C0C0C, 199, 27, 0x0C0C0C, 295, 27, 0x0C0C0C, 341, 27, 0x0C0C0C, 378, 27, 0x0C0C0C, 378, 27, 0x0C0C0C, 378, 27, 0x0C0C0C, 357, 5, 0x0B0B0C, 290, 5, 0x0B0B0C, 261, 21, 0x0C0C0C, 188, 39, 0x0C0C0C, 85, 21, 0x0C0C0C, 78, 13, 0x0B0B0C, 143, 11, 0x0B0B0C, 211, 21, 0x0C0C0C, 229, 32, 0x0C0C0C }, 90, 133, 52, 535, 112);
        if x == -1 and y == -1 then  -- 如果找到了  --加载完成了
            mSleep(500)
        else
            mSleep(1000)
            break
