...
--                                      --
--                                      --
--170529  18:00:42    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
local function action_xiaoxi() --执行这个页面的操作--
    ...
    gongneng == "pull_people_into_group" or gongneng == "hair_message_frineds"  then
...
local function action_lianxiren() --执行这个页面的操作--
    ...
    elseif gongneng == "fashuoshuo" or gongneng == "comment_friends_shuoshuo" then
        ...
        mSleep(1000)
        page_array["page_dongtai"]:enter()
    elseif gongneng == "group_message_add_friends" or gongneng == "change_login" then
