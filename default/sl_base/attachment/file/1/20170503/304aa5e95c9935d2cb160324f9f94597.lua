...
--                                             --
--                                             --
--170503  18:11:50    luoshui package 
--                                             --
--                                             --
--                                             --
-------------------------------------------------
...
local function action_sousuojiahaoyou()     --操作
    if gongneng == 2.11 then
        ...
        if gong_neng == "新号" then   --加新号为好友
            ...
            if get_main_file(xinhao_path,sl_url) == true then 
                dofile(xinhao_path);
            else
