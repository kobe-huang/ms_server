...
text_pengyouquan= {"不劳而获要不得。轻易得来的不会珍惜，还会养成贪婪的毛病。",
            "不要把别人的善良当成自己要饭的资本，谁也不亏欠你的。",
            "不要活得太卑贱，没有任何人必须对你好。",
            "每个人走的路不一样，你没有权利指三道四。承认别人的不一样，也是一种尊重。",
            "人不要说得太多，言多必失。",
...
--发文字说说内容/page_wenziss.lua
text_wenziss={"云很轻，眼皮很重，现在你在做什么？","有时候，不是对方不在乎你，而是你把对方看的太重","你喜不喜欢我，喜欢你就说啊，万一我也喜欢你呢","今天天气好好呀，但是不知道去哪玩"}
