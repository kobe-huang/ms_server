...
--                                      --
--                                      --
--170602  16:16:14    luoshui package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
local function action_lianxiren() --执行这个页面的操作--
    ...
    elseif gongneng == "agree_friends_request" then   --同意添加请求
...
local function action_new_friends_add() --执行这个页面的操作--
    if gongneng == "agree_friends_request" then  --添加群
        --没有消息
        x, y = findMultiColorInRegionFuzzy({ 0xF7F7F9, 45, 4, 0xF7F7F9, 187, 3, 0xF7F7F9, 157, 3, 0xF7F7F9, 74, 3, 0xBBBBBB, -9, 3, 0xB3B3B3, -21, 3, 0xAAAAAA, 19, 17, 0xF6F6F8, 69, 15, 0xAFAFAF, 129, 14, 0xF7F7F9, 170, 12, 0xF5F5F7, 190, 12, 0xF7F7F9 }, 90, 220, 778, 431, 795);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
            qq_warning_info("没有新的朋友添加请求")
            return false
        end
        --同意添加
        x, y = findMultiColorInRegionFuzzy({ 0x1EB9F2, 57, -1, 0x1EB9F2, 69, 1, 0x1EB9F2, 89, 3, 0x1EB9F2, 91, 5, 0x1EB9F2, 3, 11, 0x1EB9F2, 52, 16, 0x1EB9F2, 81, 17, 0x1EB9F2, 85, 15, 0x1EB9F2, 35, 22, 0x5ECDF6, 56, 23, 0x1EB9F2, 75, 24, 0x1EB9F2, 79, 25, 0x1EB9F2 }, 90, 506, 479, 597, 505);
        if x ~= -1 and y ~= -1 then  -- 如果找到了
            cicky(x,y,50);   --点击同意
            mSleep(4000)
            --好友设置
        ...
        if page_array["page_new_friends_add"]:quick_check_page() == true then
           move( 472,506, 166,506,5);  --滑动删除
           mSleep(1500)
