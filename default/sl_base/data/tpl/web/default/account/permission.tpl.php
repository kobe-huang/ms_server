...
<ol class="breadcrumb">
	...
	<li><a href="<?php  echo url('account/display');?>">顺联控制台列表</a></li>
...
<div class="clearfix">
	...
	<div class="alert alert-info">
		...
		<i class="fa fa-exclamation-circle"></i> 操作员不允许删除顺联控制台和编辑顺联控制台资料，管理员无此限制
			...
			<?php  if(is_array($permission)) { foreach($permission as $row) { ?>
				...
				<tr <?php  if(!empty($_GPC['fromuid']) && $_GPC['fromuid']== $row['uid']) { ?>style="background:#dddddd;"<?php  } ?>>
					...
					<td>
						...
						主管理员拥有顺联控制台的所有权限，并且顺联控制台的权限（模块、模板）根据主管理员来获取
