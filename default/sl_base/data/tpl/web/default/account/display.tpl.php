	...
	<div class="clearfix" style="margin-bottom:5em;">
		...
		<?php  if(!$_W['isfounder']) { ?>
			...
			<!-- <div class="alert alert-warning">
				...
				可创建 <span class="text-strong"><?php  echo $stat['maxaccount'];?> </span>个顺联控制台，已创建<span class="text-strong"> <?php  echo $stat['uniacid_num'];?> </span>个，还可创建 <span class="text-strong"><?php  echo $stat['uniacid_limit'];?> </span>个顺联控制台。
...
<!-- 		<div class="input-group">
			...
			<a class="btn btn-primary" href="<?php  echo url('account/post-step');?>"><i class="fa fa-plus"></i> 普通模式添加顺联控制台</a>

			<?php  if($_W['setting']['platform']['authstate']) { ?><a  class="btn btn-success" style="margin-left:5px;" href="<?php  echo $authurl;?>"><i class="fa fa-weixin"></i> 授权登录添加顺联控制台</a><?php  } ?>
					...
					<div class="form-group" style="margin-top:20px;margin-left: 40px">
						...
						<div class="col-sm-8 col-lg-10 col-xs-12">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control <?php  if(empty($_GPC['keyword']) && !empty($_GPC['s_uniacid'])) { ?>hide<?php  } ?>" placeholder="请输入微信顺联控制台名称" name="keyword" id="s_keyword" value="<?php  echo $_GPC['keyword'];?>">

								<input type="text" class="form-control <?php  if(empty($_GPC['s_uniacid'])) { ?>hide<?php  } ?>" placeholder="请输入微信顺联控制台ID" name="s_uniacid" id="s_uniacid" value="<?php  echo $_GPC['s_uniacid'];?>">
								...
								<div class="input-group-btn">
									...
									<ul class="dropdown-menu dropdown-menu-right" role="menu">
										...
										<li><a href="javascript:;" onclick="$('#s_uniacid').addClass('hide').val('');$('#s_keyword').removeClass('hide');">根据顺联控制台名称搜索</a></li>

										<li><a href="javascript:;" onclick="$('#s_uniacid').removeClass('hide');$('#s_keyword').addClass('hide').val('');">根据顺联控制台ID搜索</a></li>
				...
				<div class="panel panel-default">
					...
					<div class="panel-heading">
						...
						<div class="row clearfix">
							...
							<div  class="pull-right" style="margin-right: 15px;">
								...
								<a href="<?php  echo url('account/switch', array('uniacid' => $uni['uniacid']))?>" class="manage"><i class="fa fa-cog"></i>管理顺联控制台</a>
					...
					<ul class="panel-body list-group">
						...
						<li class="row list-group-item" style="line-height:60px;">
							...
							<div class="col-xs-12 col-sm-12 col-md-2 col-lg-1">
								...
								<img src="resource/images/gw-wx.gif" class="" width="50" height="50" />
					...
					<div class="list-group-bottom">
						...
						<div class="col-xs-6 text-right list-group-bottom-right">
							...
							<a href="<?php  echo url('account/display/delete', array('uniacid' => $uni['uniacid'], 'acid' => $uni['default_acid']))?>" onclick="return confirm('删除主顺联控制台其所属的子顺联控制台也会一起被放入回收站，确认吗？（可以在回收站中恢复顺联控制台）');return false;"><i class="fa fa-times"></i>删除</a>
