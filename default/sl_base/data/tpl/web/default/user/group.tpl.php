		...
		<div class="panel panel-default">
			...
			<div class="panel-body table-responsive">
				...
				<div class="form-group">
					...
					<label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">顺联控制台数量</label>

					<div class="col-sm-10 col-xs-12">

						<input type="text" class="form-control" name="maxaccount" value="<?php  echo $group['maxaccount'];?>" />

						<span class="help-block">限制顺联控制台的数量，为0则不允许添加。</span>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 col-xs-12">
						...
						<span class="help-block">设置用户组的有效期限。0为不限制期限。到期后，该用户下的所有顺联控制台只能使用 "基础服务"</span>
