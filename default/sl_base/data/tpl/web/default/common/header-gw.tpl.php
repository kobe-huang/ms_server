...
<div class="gw-container">
	<?php  if(!empty($_W['uniacid']) && !defined('IN_MESSAGE') && 1==2) { ?>
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="z-index:1001; margin-bottom:0;">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li><a href="<?php  echo url('home/welcome/platform');?>" target="_blank"><i class="fa fa-share"></i>继续管理顺联控制台（<?php  echo $_W['account']['name'];?>）</a></li>
				<?php  if(IMS_FAMILY != 'x') { ?>
